...
import { InfiniteDiscovery } from '@/components/discovery/InfiniteDiscovery';
...
export function Footer(){
 ...
 return <><InfiniteDiscovery/><footer className="aureon-footer"><div className="aureon-footer-grid">
 ...
 </div><section className="aureon-footer-legal" aria-labelledby="footer-legal-title"><div className="aureon-footer-legal-intro"><div className="aureon-footer-legal-icon" aria-hidden="true"><Scale size={25}/></div><div><p className="aureon-footer-kicker" id="footer-legal-title">Legal &amp; Policies</p><p>Read Aureon’s public terms, privacy information, subscription conditions, licensing rules and platform policies.</p></div><Link className="aureon-footer-legal-button" href="/legal"><ShieldCheck size={18}/> Open Legal Centre</Link></div></section><div className="aureon-footer-bottom"><p>{value.copyright}</p><nav aria-label="Footer links"><Link href="/artists">Artists</Link><Link href="/music">Music</Link><Link href="/videos">Videos</Link><Link href="/community">Community</Link><Link href="/contact">Contact</Link></nav></div></footer></>
}
