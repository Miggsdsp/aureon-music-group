...
type LatestPlayButtonProps = { title:string; src?:string; purchase?:SongPurchase; analytics?:SongAnalytics; buttonLabel?:string; showPurchase?:boolean; size?:'small'|'medium'|'large' };

export function LatestPlayButton({ title, src, purchase, analytics, buttonLabel, showPurchase = true, size = 'medium' }: LatestPlayButtonProps) {
