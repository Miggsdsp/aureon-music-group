...
type LatestPlayButtonProps = { title:string; src?:string; purchase?:SongPurchase; analytics?:SongAnalytics; buttonLabel?:string; showPurchase?:boolean };

export function LatestPlayButton({ title, src, purchase, analytics, buttonLabel, showPurchase = true }: LatestPlayButtonProps) {
