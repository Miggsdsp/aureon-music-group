...
const plans = [
  {
    ...
    description: 'Unlimited access to the Aureon catalogue, personal playlists and five distinct high-quality song downloads per billing month.',
    features: ['Full-track premium music streaming', 'Full video soundtracks beyond the 40-second public audio preview', 'Create and manage personal playlists', '5 distinct song downloads per billing month — not per day', 'Re-downloads of the same selected song do not use another monthly slot', 'Access to every published Aureon artist', 'Cancel anytime'],
    exclusions: ['The five-song allowance resets on the next billing date and does not roll over', 'No commercial-use licence', 'No creator licence certificates'],
  },
  {
