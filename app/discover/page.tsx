...
export const metadata={title:'Discover Aureon Music',description:'Discover personalised playlists, trending songs and emerging releases across Aureon Music Group.',alternates:{canonical:'/discover'}};
